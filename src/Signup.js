...
const SignUp = () => {
  ...
  useEffect(() => {
    axios.get('http://192.168.11.132:3000/api/office/getAllOffices')
      .then(response => {
  ...
  const handleOfficeSelect = (officeName) => {
    ...
    axios.get(`http://192.168.11.132:3000/api/department/getDepartmentsByOffice/${officeName}`)
      .then(response => {
  ...
  const handleSignUp = () => {
    ...
    axios.post('http://192.168.11.132:3000/api/v1/signup', userData)  // Replace with your actual API endpoint
      .then(response => {
